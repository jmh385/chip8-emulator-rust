...
use crate::chip8_types::{
    chip8_command::{Chip8Command, Chip8CommandData, PrecisionCalculator},
...
impl InMemoryChip8Emulator {
    pub fn new(
        ...
        scancode_to_integer: HashMap<Scancode, u8>,
    ...
    pub fn perform_action(&mut self, byte_1: u8, byte_2: u8, scancode: &mut Scancode) {
        ...
        match self.command_map.get(&command_type) {
            ...
            Some(command) => command(self, &mut command_data),
        }
    }
}
